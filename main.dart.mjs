...
_1637: v => v.toString(),
_1638: (d, digits) => d.toFixed(digits),
...
_1673: s => JSON.stringify(s),
_1674: s => printToConsole(s),
_1675: a => a.join(''),
_1676: (o, a, b) => o.replace(a, b),
_1678: (s, t) => s.split(t),
_1679: s => s.toLowerCase(),
_1680: s => s.toUpperCase(),
_1681: s => s.trim(),
_1682: s => s.trimLeft(),
_1683: s => s.trimRight(),
_1685: (s, p, i) => s.indexOf(p, i),
_1686: (s, p, i) => s.lastIndexOf(p, i),
_1687: (s) => s.replace(/\$/g, "$$$$"),
_1688: Object.is,
_1689: s => s.toUpperCase(),
_1690: s => s.toLowerCase(),
_1691: (a, i) => a.push(i),
_1695: a => a.pop(),
_1696: (a, i) => a.splice(i, 1),
_1698: (a, s) => a.join(s),
_1699: (a, s, e) => a.slice(s, e),
_1702: a => a.length,
_1704: (a, i) => a[i],
_1705: (a, i, v) => a[i] = v,
_1707: (o, offsetInBytes, lengthInBytes) => {
      var dst = new ArrayBuffer(lengthInBytes);
      new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
      return new DataView(dst);
    },
_1708: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
_1709: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
_1710: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
_1711: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
_1712: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
_1713: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
_1714: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
_1716: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
_1717: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
_1718: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
_1719: (t, s) => t.set(s),
_1721: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
_1723: o => o.buffer,
_1724: o => o.byteOffset,
_1725: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
_1726: (b, o) => new DataView(b, o),
_1727: (b, o, l) => new DataView(b, o, l),
_1728: Function.prototype.call.bind(DataView.prototype.getUint8),
_1729: Function.prototype.call.bind(DataView.prototype.setUint8),
_1730: Function.prototype.call.bind(DataView.prototype.getInt8),
_1731: Function.prototype.call.bind(DataView.prototype.setInt8),
_1732: Function.prototype.call.bind(DataView.prototype.getUint16),
_1733: Function.prototype.call.bind(DataView.prototype.setUint16),
_1734: Function.prototype.call.bind(DataView.prototype.getInt16),
_1735: Function.prototype.call.bind(DataView.prototype.setInt16),
_1736: Function.prototype.call.bind(DataView.prototype.getUint32),
_1737: Function.prototype.call.bind(DataView.prototype.setUint32),
_1738: Function.prototype.call.bind(DataView.prototype.getInt32),
_1739: Function.prototype.call.bind(DataView.prototype.setInt32),
_1742: Function.prototype.call.bind(DataView.prototype.getBigInt64),
_1743: Function.prototype.call.bind(DataView.prototype.setBigInt64),
_1744: Function.prototype.call.bind(DataView.prototype.getFloat32),
_1745: Function.prototype.call.bind(DataView.prototype.setFloat32),
_1746: Function.prototype.call.bind(DataView.prototype.getFloat64),
_1747: Function.prototype.call.bind(DataView.prototype.setFloat64),
_1761: (o, t) => o instanceof t,
...
_1765: o => Object.keys(o),
_1766: (ms, c) =>
              setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
_1767: (handle) => clearTimeout(handle),
_1768: (ms, c) =>
          setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
_1769: (handle) => clearInterval(handle),
_1770: (c) =>
...
_1783: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1784: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
_1802: () => new XMLHttpRequest(),
_1803: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1805: x0 => x0.getAllResponseHeaders(),
_1807: (s, m) => {
          try {
...
_1812: x0 => x0.pop(),
_1816: (x0,x1,x2) => x0[x1] = x2,
_1818: o => o === undefined,
_1819: o => typeof o === 'boolean',
_1820: o => typeof o === 'number',
_1822: o => typeof o === 'string',
_1825: o => o instanceof Int8Array,
_1826: o => o instanceof Uint8Array,
_1827: o => o instanceof Uint8ClampedArray,
_1828: o => o instanceof Int16Array,
_1829: o => o instanceof Uint16Array,
_1830: o => o instanceof Int32Array,
_1831: o => o instanceof Uint32Array,
_1832: o => o instanceof Float32Array,
_1833: o => o instanceof Float64Array,
_1834: o => o instanceof ArrayBuffer,
_1835: o => o instanceof DataView,
_1836: o => o instanceof Array,
_1837: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_1839: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_1840: o => o instanceof RegExp,
_1841: (l, r) => l === r,
_1842: o => o,
_1843: o => o,
_1844: o => o,
...
_1846: o => o.length,
_1849: (o, i) => o[i],
_1850: f => f.dartFunction,
_1851: l => arrayFromDartList(Int8Array, l),
_1852: (data, length) => {
...
_1853: l => arrayFromDartList(Uint8ClampedArray, l),
_1854: l => arrayFromDartList(Int16Array, l),
_1855: l => arrayFromDartList(Uint16Array, l),
_1856: l => arrayFromDartList(Int32Array, l),
_1857: l => arrayFromDartList(Uint32Array, l),
_1858: l => arrayFromDartList(Float32Array, l),
_1859: l => arrayFromDartList(Float64Array, l),
_1860: (data, length) => {
...
_1887: x0 => x0.flags,
_1888: x0 => x0.multiline,
_1889: x0 => x0.ignoreCase,
_1890: x0 => x0.unicode,
_1891: x0 => x0.dotAll,
_1892: (x0,x1) => x0.lastIndex = x1,
_1931: (x0,x1) => x0.withCredentials = x1,
_1933: x0 => x0.responseURL,
_1934: x0 => x0.status,
_1935: x0 => x0.statusText,
_1937: (x0,x1) => x0.responseType = x1,
_1938: x0 => x0.response,
_14767: x0 => x0.status,
_14768: (x0,x1) => x0.responseType = x1,
_14770: x0 => x0.response,
_14774: () => globalThis.window.flutterCanvasKit,
_14775: () => globalThis.window._flutter_skwasmInstance
    };
